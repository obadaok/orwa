...
- المصحف (القراءة، التلاوة، القراءات المتعددة)
- تقدمك في الختمات (عدد الأيام، مواضع القراءة، الرواية)
- الأذكار اليومية وإنجازاتك
- الأدعية المفضلة والمحفوظة
- العلامات المرجعية في القرآن
- آخر موضع قراءة في المصحف والختمات
- إعدادات التطبيق (الوضع الداكن، حجم الخط، الإشعارات، الاهتزاز، القراءة، إلخ)
- الإشعارات المجدولة للتذكيرات
- المفضلة والمحتويات المحفوظة
...
- المصحف الشريف بروايتي حفص ورش مع العرض المتواصل
- نظام الختمات (إنشاء ختمات، متابعة القراءة، حفظ الموضع، اختيار الرواية)
- الأذكار اليومية (الصباح والمساء وبعد الصلاة والنوم)
- الأدعية المأخوذة من حصن المسلم
- العلامات المرجعية على الآيات
- التمرير التلقائي أثناء القراءة
- شريط تقدم تفاعلي مع إمكانية السحب
- تذكيرات بالإشعارات للأذكار
- إعدادات تخصيص (الوضع الداكن، الخط، الاهتزاز، إبقاء الشاشة)
